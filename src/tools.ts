    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          firstFrame: { type: "string", description: "Image name used for the first frame." },
          lastFrame: { type: "string", description: "Image name used for the last frame." },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          attributes: { type: "object", description: "Deep-merged patch. Null deletes a field." },
        },
        required: ["name"],
      },
    },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          offset: { type: "integer", description: "Start index. Negative counts from the end." },
          limit: { type: "integer" },
